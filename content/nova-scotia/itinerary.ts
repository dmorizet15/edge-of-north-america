...
export const NS_DAYS: TripDay[] = [
  {
    ...
    dinner: "Bangor — Timber Kitchen & Bar (wood-fired) or the Sea Dog Brewing pub; downtown's indie spots are a 10-minute hop if you want livelier. Rolling in later than planned after the long drive? Both are casual, walk-in places — no reservation pressure tonight.",
  ...
  },
  {
    ...
    dinner: "The Tides at the Parkland, or Tipsy Tails — Fundy scallops and Alma lobster, the tide coming in outside the window. Both are small-village places; if one's full or closed, the other is a two-minute walk away in tiny Alma.",
  ...
  },
  {
    ...
    dinner: "[The Bicycle Thief](https://bicyclethief.ca/) on the boardwalk (reserve); or Bar Kismet if you want the local chefs' favourite. If the Bicycle Thief reservation didn't come through, Bar Kismet is five minutes further and worth booking as your backup rather than a walk-in, since it's a local favourite too.",
  ...
  },
  {
    ...
    dinner: "Lunenburg — Bar Salvador for tapas (reserve), the Old Fish Factory in the Fisheries Museum, or the Half Shell for oysters. Bar Salvador is small and reservation-only — if that falls through, the Old Fish Factory takes walk-ins right in the museum building.",
  ...
  },
  {
    ...
    dinner: "Baddeck — the community tradition of [Baddeck Lobster Suppers](https://baddecklobstersuppers.ca/) (go early, no reservations), or the Bell Buoy. Rolling into Baddeck later than planned? Lobster Suppers gets a real line after 6:30 — the Bell Buoy is the easier fallback if you're behind.",
  ...
  },
  {
    ...
    dinner: "An early Acadian supper in Chéticamp before the Skyline — Le Gabriel or the Co-op's Restaurant Acadien again both work for dinner, not just lunch; if there's a kitchen party or a fiddle session on, follow the sound afterward.",
  ...
  },
  {
    ...
    dinner: "Coastal Waters or the Main Street Restaurant & Bakery; or the Keltic Lodge's Purple Thistle if you'd like the grand dining room without the grand room rate. Sunset over Ingonish Bay. Back from Meat Cove later than planned? Main Street Restaurant & Bakery is the quickest of the three and keeps the evening free for the beach after dark — the real event tonight.",
  ...
  },
  {
    ...
    dinner: "Yarmouth — Rudder's Seafood Restaurant & Brewpub on the harbour. Rolling in past a reasonable dinner hour on this long a driving day? Rodd Grand Yarmouth has its own restaurant on site — zero travel time if you're later than planned.",
  ...
  },
  {
    ...
    dinner: "Rockland — Archer's on the Pier right on the water, or In Good Company / Cafe Miranda a block off it (reserve). Sunset over the harbour. If Archer's didn't come through or you're later off Acadia than planned, In Good Company and Cafe Miranda are both a short walk off the water and easier to land a table at last-minute.",
