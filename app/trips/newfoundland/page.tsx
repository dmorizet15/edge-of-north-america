 ...
 *
 * Preserved exactly as the original single-page experience; only relocated to
 * /trips/newfoundland so it can live as one selectable trip in the portal.
 */
export default function NewfoundlandTrip() {
  return (
